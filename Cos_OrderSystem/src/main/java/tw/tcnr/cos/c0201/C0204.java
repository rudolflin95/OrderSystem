...
import tw.tcnr.cos.c0201.recyclerAdpter.CartAdapter;
import tw.tcnr.cos.c0201.recyclerAdpter.CartItem;
import tw.tcnr.cos.c0201.recyclerAdpter.MyItem;
...
//                                        mysql_insert(Phone, Store, String.valueOf(takeaway), GrabTime);
                                        ...
                                        DBConnector.executeQueryAll(sqlquery);
                                        ArrayList<NameValuePair> nameValuePairs = new ArrayList<>();
                                        nameValuePairs.add(new BasicNameValuePair("Phone", Phone));
                                        nameValuePairs.add(new BasicNameValuePair("Store", Store));
                                        nameValuePairs.add(new BasicNameValuePair("takeaway", String.valueOf(takeaway)));
                                        nameValuePairs.add(new BasicNameValuePair("GrabTime", GrabTime));
    ...
    private void mysql_insert(String phone, String store, String takeaway, String grabTime) {
        ...
        //-----------------------------------------------
        String result = DBConnector.executeInsert("SELECT * FROM TradeRecord", nameValuePairs);
        //-----------------------------------------------
    }
    @Override
